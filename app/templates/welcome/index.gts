  ...
  <div class="flex h-full items-center justify-center p-4 w-full">
    <div class="flex flex-col h-full w-full">
      ...
      <h2 class="font-semibold mb-2 text-alt text-xl">
        Welcome to Swach 2.0.0!
      </h2>

      <p class="flex-auto mb-2 mt-2 text-main-text text-sm">
        Please take a moment to configure Swach to fit your preferred work
        style. You may have configured these settings before, but some things
        have changed in the 2.x release.
      </p>
