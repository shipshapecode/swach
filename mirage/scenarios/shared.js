export default function(server) {
  ...
  */
  ...
  //   name: 'Pale Magenta'
  // });
  // const shamrock = server.create('color', { hex: '#4af2a1', name: 'Shamrock' });
  ...
  colorHistoryPalette.createColor({ hex: '#000000', name: 'Black' });
  colorHistoryPalette.createColor({ hex: '#f78ae0', name: 'Pale Magenta' });
  colorHistoryPalette.createColor({ hex: '#4af2a1', name: 'Shamrock' });
  colorHistoryPalette.createColor({ hex: '#ffffff', name: 'White' });
}
