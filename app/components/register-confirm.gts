...
export default class RegisterConfirm extends Component {<template><div class="bg-menu p-4 rounded w-full">
  ...
  <div class="mt-3">
    <div class="mb-6">
      ...
      <div>
        ...
        <Input data-test-register-input-code class="input py-2 rounded-sm text-sm w-full" id="confirmation-code" name="confirmation-code" placeholder="Confirmation code" required @type="text" @value={{this.code}} />
      </div>
    </div>
    ...
    <div>
      <button data-test-register-submit class="btn btn-primary w-full" type="button" {{on "click" this.confirm}}>
        Confirm account
      </button>
    </div>
  </div>
